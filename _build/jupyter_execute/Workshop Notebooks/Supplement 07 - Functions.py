...
# Just so you're aware of how you'd handle this situation, if I found myself working with a list, I would do this either with a for loop:
# 
# ```python
# y_out = []
# for value in xlist:
...
# ```
#     
# Or the comprehension (generally preferred):
# 
# ```python
...
# 
# ### Example 03: Everything is better with Dungeons and Dragons Examples
# 
...
# 
# ### Example 04:  How much damage will a magic battle axe do against a Lich anyway?
# 
