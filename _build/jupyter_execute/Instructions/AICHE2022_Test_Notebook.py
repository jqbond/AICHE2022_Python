...
# ## It is worth knowing LaTeX (at least LaTeX math)
# 
# We frequently need to write equations -- why not format them nicely?
# 
# $$r = \frac{kC_A}{1 + KC_A}$$
# 
# Markdown in Jupyter has pretty robust support for LaTeX math mode; I use it extensively since it is much more readable than an equation written in text.
# 
# \begin{align}
#     \frac{dN_A}{dt} &= rV \\
...
# 
# Markdown in Jupyter also supports HTML, which you can use to enrich formatting -- pretty much anything you write in HTML can be embedded directly in a Markdown cell, and it will render correctly when the cell is executed.
# 
# <div class = "alert alert-block alert-success">
#     <b>Note</b>: If you can write a bit of HTML, you'll look like a boss<sup>&#8482;</sup> when you are discussing things like numpy arrays and <code>solve_ivp()</code> in Python.
#     </div>
